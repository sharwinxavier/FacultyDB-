...
<div id="Menualign"></div>				
	...
	<div class="container">
		<div class="content">
			...
			<h2 class="categories__title">Staff Details &raquo; Add Data &raquo; Teaching Staff	 
			<?php
					if($dept=="ADMIN"){
					echo'<a href="addnon.php" class="NTFTF" style="float:right;" ><span class="glyphicon glyphicon-transfer" aria-hidden="true"></span> &nbsp;Non-Teaching</a><br>';
					}else{ }
					?>	</h2>
			<hr />
			...
			if(isset($_POST['add'])){
				...
				if(mysqli_num_rows($check) == 0){
				    if($dept=='ADMIN'){
						$insert = mysqli_query($con, "INSERT INTO faculty_basic_details(prof_img,prof_url,ID, name, Gender, DOB, Position, Mailid, Qualification, Department, Reg_Adj, Com_Add, Per_Add, Dist, Mob_No, Community, PAN_No, Passport_No,Aadhar_No, COE_Fac_Code ,AICTE_Fac_code,Marital_status ,Birth_place ,Religion ,Blood_grp ,Catholic,Caste,Lang_Known_1,Extracurricular,Father_Name,Mother_Name,Spouse_name,Spouse_Occupation,Postal_code,STD_Code,GPM,Joining_Date,Dr_deg,PG_deg,UG_deg,Phy_Chl,AICTE_ex_mem,Schl_Qual_1,Schl_name_1,Schl_mode_1,Schl_medium_1,schl_per_1,Schl_Qual_2,Schl_name_2,Schl_mode_2,Schl_medium_2,schl_per_2,Category_1,Deg_Name_1,Specialization_1,Year_of_passing_1,Name_of_the_college_1,Name_of_the_University_1,Percentage_1,Class_Obtained_1,Clg_mode_1,Clg_medium_1,Category_2,Deg_Name_2,Specialization_2,Year_of_passing_2,Name_of_the_college_2,Name_of_the_University_2,Percentage_2,Class_Obtained_2,Clg_mode_2,Clg_medium_2,Category_3,Deg_Name_3,Specialization_3,Year_of_passing_3,Name_of_the_college_3,Name_of_the_University_3,Percentage_3,Class_Obtained_3,Clg_mode_3,Clg_medium_3,Category_4,Deg_Name_4,Specialization_4,Year_of_passing_4,Name_of_the_college_4,Name_of_the_University_4,Percentage_4,Class_Obtained_4,Clg_mode_4,Clg_medium_4,
...
Category_7,Deg_Name_7,Specialization_7,Year_of_passing_7,Name_of_the_college_7,Name_of_the_University_7,Percentage_7,Class_Obtained_7,Clg_mode_7,Clg_medium_7,Specialization_area,Add_Qual,Phd_title,Fac_Phd_award,Clg_Name_1,Designation_1,Joining_Date_1,Rel_Cur_Date_1,
...
Total_work_exp ,books_published ,Nof_Intl_papers ,
Nof_Ntl_papers ,Nof_Intl_journals ,Nof_Ntl_journals ,
Nof_PGpro_guided ,Nof_drstu_guided ,
Year_1  , Ntl_paper_1  , Intl_paper_1  ,
Ntl_Journal_1 , Intl_journal_1  , Ntl_con_1 , Intl_con_1 ,
Year_2  , Ntl_paper_2  , Intl_paper_2  ,
Ntl_Journal_2 , Intl_journal_2  , Ntl_con_2 , Intl_con_2 ,
Year_3  , Ntl_paper_3  , Intl_paper_3  ,
Ntl_Journal_3 , Intl_journal_3  , Ntl_con_3 , Intl_con_3 ,
Year_4  , Ntl_paper_4  , Intl_paper_4  ,
Ntl_Journal_4 , Intl_journal_4  , Ntl_con_4 , Intl_con_4 ,
Year_5  , Ntl_paper_5  , Intl_paper_5  ,
Ntl_Journal_5 , Intl_journal_5  , Ntl_con_5 , Intl_con_5 ,
Year_6  , Ntl_paper_6  , Intl_paper_6  ,
Ntl_Journal_6 , Intl_journal_6  , Ntl_con_6 , Intl_con_6 ,
Org_Name_1 , DesignationIN_1 ,Nature_of_work_1 ,Joining_DateIN_1,
Rel_Date_1,
Org_Name_2 , DesignationIN_2 ,Nature_of_work_2 ,Joining_DateIN_2 ,
Rel_Date_2 ,
Research_Exp  ,Patents ,
...
Old_Add ,dalit ,phd_univ ,phd_comp ,ybefme ,yafme ,iob_acc_no ,
initial_salary ,increment_salary ,projects ,add_resp ,diocese_name ,
...
'$Emp_status_7' ,'$Inc_mont_7' ,
'$Mem_Name_9' ,'$Rel_9' , '$DOB_9' ,'$HEduQual_9' ,
'$Emp_status_9' ,'$Inc_mont_9' , '$emg_mob_no' ,'$landline_no' ,'$mot_ton' ,'$Old_Add' ,'$dalit' ,'$phd_univ' ,'$phd_comp' ,'$ybefme' ,'$yafme' ,'$iob_acc_no' ,'$initial_salary' ,'$increment_salary' ,'$projects' ,'$add_resp' ,'$diocese_name' ,'$church_name_place' ,'$Email','$Lang_Known_2','$Lang_Known_3','$Lang_Known_4',
'$Lang_Known_5','$Lang_Known_6','$Lang_Known_7','$Lang_Known_8','$profic_1','$profic_2','$profic_3','$profic_4','$profic_5','$profic_6','$profic_7','$profic_8','$prof_mem_det','$other_mem_det','$Org_Name_3' , '$DesignationIN_3' ,'$Nature_of_work_3' ,'$Joining_DateIN_3','$Rel_Date_3','$Org_Name_4' , '$DesignationIN_4' ,'$Nature_of_work_4' ,'$Joining_DateIN_4',
'$Rel_Date_4','$Org_Name_5' , '$DesignationIN_5' ,'$Nature_of_work_5' ,'$Joining_DateIN_5',
'$Rel_Date_5'
...
'$Rel_Date_5'
 ...
 or die(mysqli_error($con));}
						...
						if($insert){
							...
							echo '<br><div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Oops! Employee data failed to save</div>';
						}
   ...
   <!--         </form>-->
			<!--<form class="form-horizontal" action="" method="post">-->
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="COE_Fac_Code" class="form-control" placeholder="COE Faculty Code" >
					</div>
				</div>				
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="AICTE_Fac_code" class="form-control" placeholder="AICTE Faculty Code" >
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="Dr_deg" class="form-control" placeholder="Doctorate degree" >
					</div>
				</div>
...
<!-- 
				...
				<div class="form-group">
				<label class="col-sm-2 control-label">Title of Ph.D Thesis</label>
					<div class="col-sm-10">
						<input type="text" name="Phd_title" class="form-control" placeholder="THESIS TITLE" >
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">Faculty in which Ph.D was awarded</label>
					<div class="col-sm-10">
						<input type="text" name="Fac_Phd_award" class="form-control" placeholder="Faculty in which Ph.D was awarded" >
					</div>	
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">Ph.D University</label>
					<div class="col-sm-10">
						<input type="text" name="phd_univ" class="form-control" placeholder="Ph.D University" >
					</div>	
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">Ph.D year of completion</label>
					<div class="col-sm-10">
						<input type="text" name="phd_comp" class="form-control" placeholder="Ph.D year of completion" >
					</div>	
				</div>
			...
			<div>
                ...
                <label class="col-sm-2 control-label">Total Work Experience</label>
                    <div class="col-sm-2">
                        <input type="number" name="Total_work_exp" class="form-control" placeholder="Total Work Experience" >
                    </div>
                    <label class="col-sm-2 control-label">Years of experience before ME</label>
                    <div class="col-sm-2">
                        <input type="number" name="ybefme" class="form-control" placeholder="Experience before ME" >
                    </div>
                    <label class="col-sm-2 control-label">Years of experience after ME</label>
                    <div class="col-sm-2">
                        <input type="number" name="yafme" class="form-control" placeholder="Experience after ME" >
                    </div>
                </div>
                <div class="form-group">
                <label class="col-sm-2 control-label">Books Published</label>
                    <div class="col-sm-2">
                        <input type="number" name="books_published" class="form-control" placeholder="Books Published" >
                    </div>
                <label class="col-sm-2 control-label">No of International Papers</label>
                    <div class="col-sm-2">
                        <input type="number" name="Nof_Intl_papers" class="form-control" placeholder="No of International Papers" >
                    </div>
                <label class="col-sm-2 control-label">No of National Papers</label>
                    <div class="col-sm-2">
                        <input type="number" name="Nof_Ntl_papers" class="form-control" placeholder="No of National Papers" >
                    </div>  
                </div>
                <div class="form-group">
                <label class="col-sm-2 control-label">No of International Journals</label>
                    <div class="col-sm-2">
                        <input type="text" name="Nof_Intl_journals" class="form-control" placeholder="No of International Journals" >
                    </div>  
                <label class="col-sm-2 control-label">No of National Journals</label>
                    <div class="col-sm-2">
                        <input type="text" name="Nof_Ntl_journals" class="form-control" placeholder="No of National Journals" >
                    </div>
                  
                
                <label class="col-sm-2 control-label">No of UG/PG Projects Guided</label>
                    <div class="col-sm-2">
                        <input type="text" name="Nof_PGpro_guided" class="form-control" placeholder="UG projects / PG Projects" >
                    </div>  
                </div>
                <div class="form-group">
                <label class="col-sm-2 control-label">No of Doctorate Students Guided</label>
                    <div class="col-sm-2">
                        <input type="text" name="Nof_drstu_guided" class="form-control" placeholder="No of Doctorate Students Guided" >
                    </div>
                ...
                <label class="col-sm-2 control-label">No of Patents published</label>
					<div class="col-sm-2">
						<input type="text" name="Patents" class="form-control" placeholder="Number of patents published" >
					</div>	
                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="number" name="Year_1" class="form-control" placeholder="Year" >
					</div>
					<label class="col-sm-2 control-label">National Papers</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_paper_1" class="form-control" placeholder="National Papers" >
					</div>
					<label class="col-sm-2 control-label">International Papers</label>
					<div class="col-sm-2">
						<input type="number" name="Intl_paper_1" class="form-control" placeholder="International Papers" >
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">National Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Ntl_Journal_1" class="form-control" placeholder="National Journal" >
                    </div>
                    <label class="col-sm-2 control-label">International Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Intl_journal_1" class="form-control" placeholder="International Journals">
                    </div>
                    
					<label class="col-sm-2 control-label">National Conference</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_con_1" class="form-control" placeholder="National Conferences" >
					</div>
					</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">International Conference</label>
					<div class="col-sm-2">				
						<input type="number" name="Intl_con_1" class="form-control" placeholder="International Conferences" >
					</div>
				</div>
				</div>
				<br>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="number" name="Year_2" class="form-control" placeholder="Year" >
					</div>
					<label class="col-sm-2 control-label">National Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_paper_2" class="form-control" placeholder="National Papers" >
					</div>
					<label class="col-sm-2 control-label">International Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Intl_paper_2" class="form-control" placeholder="International Papers" >
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">National Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Ntl_Journal_2" class="form-control" placeholder="National Journal" >
                    </div>
                    <label class="col-sm-2 control-label">International Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Intl_journal_2" class="form-control" placeholder="International journal">
                    </div>
                
					<label class="col-sm-2 control-label">National Conference</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_con_2" class="form-control" placeholder="National Conference" >
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">International Conference</label>
					<div class="col-sm-2">				
						<input type="number" name="Intl_con_2" class="form-control" placeholder="International Conference" >
					</div>
				</div>
				</div>
				<br>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="number" name="Year_3" class="form-control" placeholder="Year" >
					</div>
					<label class="col-sm-2 control-label">National Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_paper_3" class="form-control" placeholder="National Papers" >
					</div>
					<label class="col-sm-2 control-label">International Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Intl_paper_3" class="form-control" placeholder="International Papers" >
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">National Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Ntl_Journal_3" class="form-control" placeholder="National Journals" >
                    </div>
                    <label class="col-sm-2 control-label">International Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Intl_journal_3" class="form-control" placeholder="International Journals">
                    </div>
                
					<label class="col-sm-2 control-label">National Conference</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_con_3" class="form-control" placeholder="National Conferences" >
					</div>
					</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">International Conference</label>
					<div class="col-sm-2">				
						<input type="number" name="Intl_con_3" class="form-control" placeholder="International Conferences" >
					</div>
				</div>
				</div>
				<br>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="number" name="Year_4" class="form-control" placeholder="Year" >
					</div>
					<label class="col-sm-2 control-label">National Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_paper_4" class="form-control" placeholder="National Papers" >
					</div>
					<label class="col-sm-2 control-label">International Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Intl_paper_4" class="form-control" placeholder="International Papers" >
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">National Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Ntl_Journal_4" class="form-control" placeholder="National Journals" >
                    </div>
                    <label class="col-sm-2 control-label">International Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Intl_journal_4" class="form-control" placeholder="International Journals">
                    </div>
                
					<label class="col-sm-2 control-label">National Conference</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_con_4" class="form-control" placeholder="National Conferences" >
					</div>
					</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">International Conference</label>
					<div class="col-sm-2">				
						<input type="number" name="Intl_con_4" class="form-control" placeholder="International Conferences" >
					</div>
				</div>
				</div>
				<br>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="number" name="Year_5" class="form-control" placeholder="Year" >
					</div>
					<label class="col-sm-2 control-label">National Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_paper_5" class="form-control" placeholder="National Papers" >
					</div>
					<label class="col-sm-2 control-label">International Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Intl_paper_5" class="form-control" placeholder="International Papers" >
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">National Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Ntl_Journal_5" class="form-control" placeholder="National Journals" >
                    </div>
                    <label class="col-sm-2 control-label">International Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Intl_journal_5" class="form-control" placeholder="International Journals">
                    </div>
                
					<label class="col-sm-2 control-label">National Conference</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_con_5" class="form-control" placeholder="National Conferences" >
					</div>
					</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">International Conference</label>
					<div class="col-sm-2">				
						<input type="number" name="Intl_con_5" class="form-control" placeholder="International Conferences" >
					</div>
				</div>
				</div>
				<br>
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="number" name="Year_6" class="form-control" placeholder="Year" >
					</div>
					<label class="col-sm-2 control-label">National Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_paper_6" class="form-control" placeholder="National Papers" >
					</div>
					<label class="col-sm-2 control-label">International Paper</label>
					<div class="col-sm-2">
						<input type="number" name="Intl_paper_6" class="form-control" placeholder="International Papers" >
					</div>
				</div>
				<div class="form-group">
				<label class="col-sm-2 control-label">National Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Ntl_Journal_6" class="form-control" placeholder="National Journals" >
                    </div>
                    <label class="col-sm-2 control-label">International Journal</label>
                    <div class="col-sm-2">
                        <input type="number" name="Intl_journal_6" class="form-control" placeholder="International Journals">
                    </div>
                
					<label class="col-sm-2 control-label">National Conference</label>
					<div class="col-sm-2">
						<input type="number" name="Ntl_con_6" class="form-control" placeholder="National Conferences" >
					</div></div>
				<div class="form-group">
					<label class="col-sm-2 control-label">International Conference</label>
					<div class="col-sm-2">				
						<input type="number" name="Intl_con_6" class="form-control" placeholder="International Conferences" >
					</div>
				</div>
				</div>
				<br>
				...
				<label class="col-sm-2 control-label">Research Experience</label>
					<div class="col-sm-3">
						<input type="text" name="Research_Exp" class="form-control" placeholder="Research Experience" >
					</div>	
