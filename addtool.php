...
<div id="Menualign"></div>				
	...
	<div class="container">
		<div class="content">
			...
			<h2 class="categories__title">Staff Details &raquo; Add Login</h2>
			<hr />
			...
			if(isset($_POST['add'])){
				...
				$insert = mysqli_query($con, "INSERT INTO users(id,userid,username,password,Department)
                VALUES('$id','$userid','$username', '$password', '$Department')")
